package com.sunilprakash.wapp;

import com.sunilprakash.wapp.config.Constants;
import com.sunilprakash.wapp.config.CommonProperties;
...
@EnableConfigurationProperties({ CommonProperties.class, LiquibaseProperties.class })
